...
def main(args):
    ...
    if rank == 0:
        memory_limit(0.7) # Limitates maximun memory usage to half
    else:
    ...
    if cfg.resume:
        ...
        del dict_checkpoint
    if cfg.finetune_bb:
        dict_checkpoint_bb = torch.load(cfg.finetune_bb)
        backbone.module.load_state_dict(dict_checkpoint_bb)
        del dict_checkpoint_bb
